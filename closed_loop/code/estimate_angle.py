...
for frequ in range(len(frequency)):
	...
	path = '/home/spinnaker/Documents/projects/Sevilla_2021_TDE_SSL/data/final/closed_loop/'+str(frequency[frequ])+'Hz/video_crop/'
	video_name = []
	os.chdir(path)
	...
	#for idx in range(2):
		...
		ax.plot(np.array(angle), np.array(range(len(angle)))/25.0, marker = '.', ms = 1, color = 'b', linewidth = 0)
		...
		ax2.plot(np.array(angle)+np.pi, np.array(range(len(angle)))/25.0, marker = '.', ms = 3, linewidth = 0.5, color= colors[idx])
		ax2.set_xticks(np.pi/180. * np.linspace(0,  360, 36, endpoint=False))
		ax2.set_ylim([-20,110])
		fig2.savefig('/home/spinnaker/Documents/projects/Sevilla_2021_TDE_SSL/data/final/closed_loop/'+str(frequency[frequ])+'Hz/results/polarplot_all_'+str(frequency[frequ])+'Hz.png', dpi=300)
		
		ax3.plot(np.array(angle)+np.pi/2, np.array(range(len(angle)))/25.0, marker = '.', ms = 3, linewidth = 0.5, color= colors[idx])
		ax3.set_xticks(np.pi/180. * np.linspace(0,  360, 36, endpoint=False))
		ax3.set_ylim([-10,15])
		fig3.savefig('/home/spinnaker/Documents/projects/Sevilla_2021_TDE_SSL/data/final/closed_loop/'+str(frequency[frequ])+'Hz/results/polarplot_all_turn_'+str(frequency[frequ])+'Hz.png', dpi=300)
...
ax.set_ylim([-20,110])
fig.savefig('/home/spinnaker/Documents/projects/Sevilla_2021_TDE_SSL/data/final/closed_loop/'+str(frequency[0])+'Hz/results/polarplot_mean_' +str(frequency[0]) + 'Hz.png', dpi=300)
