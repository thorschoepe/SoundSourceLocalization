...
#ifndef IAF_PSC_EXP_ITDE2_H
#define IAF_PSC_EXP_ITDE2_H
 ...
 */
class iaf_psc_exp_itde2 : public nest::Archiving_Node
{
public:
  iaf_psc_exp_itde2();
  iaf_psc_exp_itde2( const iaf_psc_exp_itde2& );
...
private:
  ...
  friend class nest::RecordablesMap< iaf_psc_exp_itde2 >;
  friend class nest::UniversalDataLogger< iaf_psc_exp_itde2 >;
  ...
  struct State_
  {
    ...
    double threshold_;																		// newly inserted variable for old current value
  ...
  struct Buffers_
  {
    Buffers_( iaf_psc_exp_itde2& );
    Buffers_( const Buffers_&, iaf_psc_exp_itde2& );
    ...
    nest::UniversalDataLogger< iaf_psc_exp_itde2 > logger_;
  };
  ...
  static nest::RecordablesMap< iaf_psc_exp_itde2 > recordablesMap_;
};


inline nest::port
mynest::iaf_psc_exp_itde2::send_test_event( Node& target,
...
inline nest::port
mynest::iaf_psc_exp_itde2::handles_test_event( nest::SpikeEvent&, nest::rport receptor_type )
{
  if ( receptor_type != 0 )
...
inline nest::port
mynest::iaf_psc_exp_itde2::handles_test_event( nest::CurrentEvent&, nest::rport receptor_type )
{
  if ( receptor_type == 0 )
    return 0;
...
inline nest::port
mynest::iaf_psc_exp_itde2::handles_test_event( nest::DataLoggingRequest& dlr, nest::rport receptor_type )
{
  if ( receptor_type != 0 )
    throw nest::UnknownReceptorType( receptor_type, get_name() );
...
inline void
iaf_psc_exp_itde2::get_status( DictionaryDatum& d ) const
{
  P_.get( d );
  S_.get( d, P_ );
...
inline void
iaf_psc_exp_itde2::set_status( const DictionaryDatum& d )
{
