...
#ifndef IAF_PSC_LIN_SEMD_H
#define IAF_PSC_LIN_SEMD_H
 ...
 */
class iaf_psc_lin_semd : public nest::Archiving_Node
{
public:
  iaf_psc_lin_semd();
  iaf_psc_lin_semd( const iaf_psc_lin_semd& );
...
private:
  ...
  friend class nest::RecordablesMap< iaf_psc_lin_semd >;
  friend class nest::UniversalDataLogger< iaf_psc_lin_semd >;
  ...
  struct Buffers_
  {
    Buffers_( iaf_psc_lin_semd& );
    Buffers_( const Buffers_&, iaf_psc_lin_semd& );
    ...
    nest::UniversalDataLogger< iaf_psc_lin_semd > logger_;
  };
  ...
  static nest::RecordablesMap< iaf_psc_lin_semd > recordablesMap_;
};


inline nest::port
mynest::iaf_psc_lin_semd::send_test_event( Node& target,
...
inline nest::port
mynest::iaf_psc_lin_semd::handles_test_event( nest::SpikeEvent&, nest::rport receptor_type )
{
  if ( receptor_type != 0 )
...
inline nest::port
mynest::iaf_psc_lin_semd::handles_test_event( nest::CurrentEvent&, nest::rport receptor_type )
{
  if ( receptor_type == 0 )
    return 0;
...
inline nest::port
mynest::iaf_psc_lin_semd::handles_test_event( nest::DataLoggingRequest& dlr, nest::rport receptor_type )
{
  if ( receptor_type != 0 )
    throw nest::UnknownReceptorType( receptor_type, get_name() );
...
inline void
iaf_psc_lin_semd::get_status( DictionaryDatum& d ) const
{
  P_.get( d );
  S_.get( d, P_ );
...
inline void
iaf_psc_lin_semd::set_status( const DictionaryDatum& d )
{
