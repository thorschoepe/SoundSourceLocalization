...
mynest::MyModule2 mymodule_LTX_mod;
#endif
// -- DynModule functions ------------------------------------------------------

mynest::MyModule2::MyModule2()
{
#ifdef LINKED_MODULE
...
const std::string
mynest::MyModule2::name( void ) const
{
  return std::string( "My NEST Module" ); // Return name of the module
}

const std::string
mynest::MyModule2::commandstring( void ) const
{
...
void
mynest::MyModule2::init( SLIInterpreter* i )
{
  ...
  */
  ...
  nest::kernel().model_manager.register_node_model< iaf_psc_exp_itde >(
    "iaf_psc_exp_itde" );
  nest::kernel().model_manager.register_node_model< iaf_psc_exp_itde2 >(
    "iaf_psc_exp_itde2" );
  nest::kernel().model_manager.register_node_model< iaf_psc_exp_semd >(
    "iaf_psc_exp_semd" );
  nest::kernel().model_manager.register_node_model< iaf_psc_lin_semd >(
    "iaf_psc_lin_semd" );
