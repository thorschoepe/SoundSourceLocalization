...
#ifndef IAF_PSC_EXP_ITDE_H
#define IAF_PSC_EXP_ITDE_H
 ...
 */
class iaf_psc_exp_itde : public nest::Archiving_Node
{
public:
  iaf_psc_exp_itde();
  iaf_psc_exp_itde( const iaf_psc_exp_itde& );
...
private:
  ...
  friend class nest::RecordablesMap< iaf_psc_exp_itde >;
  friend class nest::UniversalDataLogger< iaf_psc_exp_itde >;
  ...
  struct Buffers_
  {
    Buffers_( iaf_psc_exp_itde& );
    Buffers_( const Buffers_&, iaf_psc_exp_itde& );
    ...
    nest::UniversalDataLogger< iaf_psc_exp_itde > logger_;
  };
  ...
  static nest::RecordablesMap< iaf_psc_exp_itde > recordablesMap_;
};


inline nest::port
mynest::iaf_psc_exp_itde::send_test_event( Node& target,
...
inline nest::port
mynest::iaf_psc_exp_itde::handles_test_event( nest::SpikeEvent&, nest::rport receptor_type )
{
  if ( receptor_type != 0 )
...
inline nest::port
mynest::iaf_psc_exp_itde::handles_test_event( nest::CurrentEvent&, nest::rport receptor_type )
{
  if ( receptor_type == 0 )
    return 0;
...
inline nest::port
mynest::iaf_psc_exp_itde::handles_test_event( nest::DataLoggingRequest& dlr, nest::rport receptor_type )
{
  if ( receptor_type != 0 )
    throw nest::UnknownReceptorType( receptor_type, get_name() );
...
inline void
iaf_psc_exp_itde::get_status( DictionaryDatum& d ) const
{
  P_.get( d );
  S_.get( d, P_ );
...
inline void
iaf_psc_exp_itde::set_status( const DictionaryDatum& d )
{
